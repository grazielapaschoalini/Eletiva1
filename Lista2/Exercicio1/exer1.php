...
<body> <!--funções de inclusão Bootstrap Navbar - para chamar a função 2 funções e duas variações (include)  abre mesmo a função dando erro (require) se der erro na função ele trava e nao abre-->
<!--include once ou require once se vc chamar a mesma função 2 x ela nao repete -->
  <?php 
    require_once("../nav.php"); // ../ chama a pasta anterior
  ?>
