...
<body class="container">
  <h1>Exercício 20 - Calcular Velocidade Média (m/s)</h1>
  <form action="exer20resp.php" method="POST">
    <div class="row">
      <div class="col">
        <label for="valor1" class="form-label">Informe a distancia (Km): </label>
        <input type="number" class="form-control" name="valor1" id="valor1">
      </div>
      <div class="col">
        <label for="valor2" class="form-label">Informe o tempo (h): </label>
